  ...
  return (
    <div className="min-h-screen bg-[#09111d] text-white">
      <div className="mx-auto grid min-h-screen w-full max-w-[1680px] lg:grid-cols-[292px_1fr]">
        ...
        <div className="flex min-h-screen flex-col bg-[linear-gradient(180deg,#09111d_0%,#111b2b_18%,#131f31_100%)]">
          <PortalHeader eyebrow="Buyer portal" title="Không gian bên mua" />
